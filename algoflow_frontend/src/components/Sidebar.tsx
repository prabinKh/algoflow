...
export default function Sidebar({
  ...
  const { isAuthenticated, isStaff, isAdmin, user } = useAuth();
  ...
  // Check if user can access dashboard (must be authenticated and email verified)
  const canAccessDashboard = isAuthenticated && user?.email_verified;
  
  // Check if user can access forge (must be staff or admin)
  const canAccessForge = isStaff || isAdmin;
