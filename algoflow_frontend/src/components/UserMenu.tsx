...
import { User, LogIn, UserPlus, LogOut, ChevronDown, Shield } from 'lucide-react';
                  ...
                  <>
                    {(isStaff || isAdmin) && (
                      <button
                        ...
                        className="w-full flex items-center gap-3 px-4 py-3 text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-emerald-500/10 text-emerald-400 transition-all"
                      >
                        <Shield size={16} />
                        Admin Panel
                      </button>
